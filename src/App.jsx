          ...
          <div className="page-enter">
            <Suspense fallback={<PageLoader />}>
              <Routes>
                ...
                <Route
                  path="/leads"
                  element={<Leads showToast={showToast} />}
                />
                <Route
                  path="/failed-leads"
                  element={<FailedLeads showToast={showToast} />}
                />
                <Route
                  path="/leads/:id"
                  element={<LeadDetail showToast={showToast} />}
                />
                <Route
                  path="/schedule"
                  element={<Schedule showToast={showToast} />}
                />
                <Route
                  path="/emails"
                  element={<EmailQueue showToast={showToast} />}
                />
                <Route
                  path="/analytics"
                  element={<Analytics showToast={showToast} />}
                />
                <Route
                  path="/templates"
                ...
                />
                <Route
                  path="/conditional-emails"
                  element={<ConditionalEmails showToast={showToast} />}
                />
                <Route
                  path="/terminal-states"
                  element={<TerminalStates showToast={showToast} />}
                />
                <Route
                  path="/upload"
                  element={<Upload showToast={showToast} />}
                />
                <Route
                  path="/settings"
